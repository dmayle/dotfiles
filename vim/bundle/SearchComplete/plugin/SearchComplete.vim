...
" Key mappings
"-------------------------------------------------- 
" To hide the call, we use silent, but that also hides the '/', making us think
" that search hasn't started.  So instead, he hide everything, but echo the '/'
" to everything looks as expected.
nnoremap <silent> / :exec ":echo '/'\|:call SearchCompleteStart()"<CR>/
...
function! SearchCompleteStart()
	...
	cnoremap <silent> <C-[> <C-C>:call SearchCompleteStop()<CR>
endfunction
