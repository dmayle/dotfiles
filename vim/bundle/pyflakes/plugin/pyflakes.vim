...
" Make sure this is called on [only/all] python buffers.
au FileType python call PFBufSetup()
if maparg("<Leader>pf") =~ 'PFBufSetup'
  nunmap <Leader>pf
endif

nmap <script> <silent> <unique> <Leader>pf :call PFBufSetup()<CR>

if !exists("*PFBufSetup")
  function PFBufSetup()
